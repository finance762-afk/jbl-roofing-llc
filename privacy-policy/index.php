...
<article class="legal-prose">
  ...
  <ul>
    ...
    <li><strong>Legal compliance:</strong> if required by <?php echo htmlspecialchars($companyState); ?> or federal law.</li>
    <li><strong>Business transfers:</strong> in the event of a merger, acquisition, or sale of business assets.</li>
  </ul>

  <h2>5. Your Privacy Rights</h2>

  <h3 id="state-rights"><?php echo htmlspecialchars($companyState); ?> Residents</h3>
  ...
  <p><strong>How to exercise your rights:</strong> Email <a href="mailto:<?php echo htmlspecialchars($email); ?>"><?php echo htmlspecialchars($email); ?></a><?php if (!empty($phone)): ?> or call <a href="tel:<?php echo htmlspecialchars($phone); ?>"><?php echo htmlspecialchars(formatPhone($phone)); ?></a><?php endif; ?>. We will respond within 45 days of receipt.</p>
