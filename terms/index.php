...
$pageDescription  = 'Terms governing use of ' . $siteName . ' website and engagement of our roofing services in Fort Smith, AR.';
...
<section class="hero hero--legal" aria-label="Terms of Service">
  <div class="hero__copy">
    ...
    <span class="section-subtitle">agreement to terms</span>
...
<article class="legal-prose">
  ...
  <ul>
    ...
    <li>All workers carry workers' compensation insurance as required by <?php echo htmlspecialchars($companyState); ?> law.</li>
  ...
  <p>We accept check, electronic transfer, and financing through approved third-party providers. Past-due balances may accrue interest as permitted by <?php echo htmlspecialchars($companyState); ?> law.</p>
